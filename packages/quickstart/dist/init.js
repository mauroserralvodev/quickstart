...
function template(name) {
    ...
    if (name === "lib/brinpage.ts")
        return BRINPAGE_TS;
    if (name === "api/chat/route.ts")
        return API_CHAT_ROUTE_TS;
    if (name === "demo/page.tsx")
        return DEMO_PAGE_TSX;
    if (name === ".env.local")
        return ENV_LOCAL;
